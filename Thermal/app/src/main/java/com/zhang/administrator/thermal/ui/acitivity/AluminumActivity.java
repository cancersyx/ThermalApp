 ...
 */
public class AluminumActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.IB_back:
                startActivity(new Intent(AluminumActivity.this, MetalCategoryActivity.class));
                break;
        }
