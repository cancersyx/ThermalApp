...
//                mWebView.loadUrl(url);
            ...
            case R.id.set:
                flag = true;
                startActivity(new Intent(MainActivity.this, Set_Activity.class));
                Intent intent=getIntent();
                finish();
                break;
            case R.id.imagebut1:
                startActivity(new Intent(MainActivity.this,MetalCategory_Activity.class));
                finish();
                break;
            case R.id.imagebut2:
                startActivity(new Intent(MainActivity.this,LiXueXingNeng_Activity.class));
                finish();
                break;

            case R.id.imagebut3:
                startActivity(new Intent(MainActivity.this,JinXiangZhuZhi_Activity.class));
                finish();
                break;
            case R.id.imagebut4:
                startActivity(new Intent(MainActivity.this,Formula_Activity.class));
                finish();
                break;
