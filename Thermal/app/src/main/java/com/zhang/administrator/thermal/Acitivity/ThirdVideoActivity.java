 ...
 */
public class ThirdVideoActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        Listener();
        mVideo.setVideoPath("/storage/emulated/0/video/video3.3gp");
        mVideo.requestFocus();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.First_Video_back:
                startActivity(new Intent(ThirdVideoActivity.this,MainActivity.class));
                finish();
                break;
            case R.id.play:
                mVideo.start();
