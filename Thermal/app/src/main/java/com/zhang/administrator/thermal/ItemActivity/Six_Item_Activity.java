 ...
 */
public class Six_Item_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IB_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Six_Item_Activity.this, LiXueXingNeng_Activity.class));
            }
        });
        showFirstItem();
    ...
    private void showFirstItem() {
        InputStream inputStream = getResources().openRawResource(R.raw.su);
